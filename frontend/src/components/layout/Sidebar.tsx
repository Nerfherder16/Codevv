...
export function Sidebar() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-center border-b border-gray-200 dark:border-gray-800 px-3 py-4">
        {collapsed ? (
          <img
            src="/codevvtrans.png"
            alt="Codevv"
            className="w-10 h-10 shrink-0 rounded object-contain"
          />
        ) : (
          <img
