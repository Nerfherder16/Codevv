    ...
    <div>
      ...
      {jobs.length === 0 ? (
        <EmptyState
          ...
          title="No scaffold jobs yet"
          description="Select components from a canvas and generate code."
          actionLabel="New Scaffold"
                  ...
                  {components.map((comp) => (
                    ...
                    >
                      <input
                        ...
                        className="rounded border-gray-300 dark:border-gray-600 text-teal focus:ring-teal"
                      />
